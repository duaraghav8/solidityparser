...
// EnterNatSpec is called when production natSpec is entered.
func (s *BaseSolidityListener) EnterNatSpec(ctx *NatSpecContext) {}

// ExitNatSpec is called when production natSpec is exited.
func (s *BaseSolidityListener) ExitNatSpec(ctx *NatSpecContext) {}
