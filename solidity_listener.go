...
type SolidityListener interface {
	...
	// EnterNatSpec is called when entering the natSpec production.
	EnterNatSpec(c *NatSpecContext)
	...
	// ExitNatSpec is called when exiting the natSpec production.
	ExitNatSpec(c *NatSpecContext)
